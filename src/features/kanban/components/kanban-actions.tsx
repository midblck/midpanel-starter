...
export function KanbanActions({
  ...
  const [currentColumnToDelete, setCurrentColumnToDelete] = useState<Column | null>(null)
  const [currentTaskToDelete, setCurrentTaskToDelete] = useState<Task | null>(null)
  ...
  const handleEditTask = (task: Task) => {
    window.dispatchEvent(new CustomEvent('kanban-edit-task', { detail: { task } }))
  }

  const handleAddTask = (columnId: string) => {
    window.dispatchEvent(new CustomEvent('kanban-add-task', { detail: { columnId } }))
  }
